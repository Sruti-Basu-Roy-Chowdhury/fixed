...
<div className="mt-16 bg-[#E3F2FD] p-15 rounded-2xl shadow-lg text-left max-w-4xl mx-auto font-[poppins] mb-80">
  ...
  <div className="flex justify-left gap-4 mt-6 font-[poppins]">
    <button className="px-6 py-3 bg-white text-[#05445E] border border-gray-300 rounded-xl text-sm font-semibold hover:bg-gray-200 flex items-center">
      <img src="https://cdn1.iconfinder.com/data/icons/google-s-logo/150/Google_Icons-09-512.png" alt="Google" className="h-5 w-5 mr-2" />
      Sign up with Google
    </button>
...
<div>
<div className=" bg-white p-20 text-left w-screen -ml-12 bottom-0 absolute ">
<img src={logo} alt="Logo" className="h-[80px]" />
  <h2 className="text-sm font-semibold text-[#000000] text-left">Sign up now and join over 10,000 remote workers who receive 
    <br/>personalized job alerts, curated job matches, and more for free!</h2>

    <div className="flex justify-end items-start">
  <img src={Image30} alt="img" className="w-auto h-auto -mt-25" />
</div>



    <div className="flex justify-left gap-2 mt-2">
    <img src={Image26} alt="Find a Job"  />
    <img src={Image27} alt="Find a Job"  />
    <img src={Image28} alt="Find a Job"  />
    <img src={Image29} alt="Find a Job"  />
</div>

<div className="grid grid-cols-4 gap-6 text-[#1A1A1A] max-w-6xl mx-auto mt-8 -ml-2">
  
  {/* Column 1 */}
  <div>
    <h1 className="font-bold mb-2">About Company</h1>
    <p>
      Contact Us <br />
      Terms & Conditions <br />
      Privacy Policy <br />
  ...
  {/* Column 2 */}
  <div>
    <h1 className="font-bold mb-2">For Candidate</h1>
    <p>
    Create Resumes <br />
  ...
  {/* Column 3 */}
  <div>
    <h1 className="font-bold mb-2">For Employers</h1>
    <p>
    Post a job <br />
    Job packages <br />
  ...
  {/* Column 4 */}
  <div>
    <h1 className="font-bold mb-2">For Consultants</h1>
    <p>
      About Us <br />
      Careers <br />
      Press <br />
...
<hr className="border-t border-gray-300 my-4 w-340 " />
<br/>
<div className="mt-5">
